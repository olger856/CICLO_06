...
import pe.edu.upeu.asistenciaupeujc.ui.presentation.screens.GameScreen
import pe.edu.upeu.asistenciaupeujc.ui.presentation.screens.GameViewModel
...
fun NavigationHost(
    ...
    NavHost(
        ...
        composable(Destinations.GameScreen.route) { GameScreen(GameViewModel()) }
